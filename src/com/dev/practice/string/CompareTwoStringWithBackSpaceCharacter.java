package com.dev.practice.string;
public class CompareTwoStringWithBackSpaceCharacter {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(CompareTwoStringWithBackSpaceCharacter.ifStringEqualContainingBackspace("bcd##e", "bd#e"));
  }
