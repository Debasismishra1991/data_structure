...
public class Find1stOccurrenceOfValueInArrayIfAdjacentValuesDifferByK {
	...
	static public class ArrayApp {
		...
		public static void main(String[] args) {
			...
			Find1stOccurrenceOfValueInArrayIfAdjacentValuesDifferByK a = new Find1stOccurrenceOfValueInArrayIfAdjacentValuesDifferByK();
