...
public class FindTopKFrequentElementInArray {
	...
	public static void main(String[] args) {
		...
		System.out.println(FindTopKFrequentElementInArray.topKFrequentlyOccurredNumbersUsingMinHeap(arr, k));

		System.out.println(FindTopKFrequentElementInArray.topKFrequentlyOccurredNumbersUsingMaxHeap(arr, k));
