...
public class FindKthSmallestNumberInArray {
	...
	public static void main(String[] args) {
		...
		System.out.println(FindKthSmallestNumberInArray.kthSmallestElementInGivenArrayMaxHeap(arr, k));
		System.out.println(FindKthSmallestNumberInArray.kthSmallestElementInGivenArrayMinHeap(arr, k));
