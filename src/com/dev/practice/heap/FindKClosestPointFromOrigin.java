...
public class FindKClosestPointFromOrigin {
  ...
  public static void main(String[] args) {
    ...
    List<Coordinate> kClosestPointsUsingList = FindKClosestPointFromOrigin.kClosestPointFromOriginUsingList(listOfCoordinate, 2);
    ...
    List<Coordinate> kClosestPointsUsingMinHeap = FindKClosestPointFromOrigin.kClosestPointFromOriginUsingMinHeap(listOfCoordinate, 2);
    ...
    List<Coordinate> kClosestPointsUsingMaxHeap = FindKClosestPointFromOrigin.kClosestPointFromOriginUsingMaxHeap(listOfCoordinate, 2);
